...
export default function OrderNow() {
  return (
    <div style={{ background: '#fff', minHeight: '100vh', fontFamily: 'Inter, sans-serif' }}>
      <section style={{ maxWidth: 700, margin: '0 auto', padding: '48px 16px 0 16px' }}>
        <h1 style={{ textAlign: 'center', fontSize: 40, fontWeight: 700, marginBottom: 12, color: '#111' }}>Get Your Quote</h1>
        ...
        <div style={{ background: '#fff', border: '1.5px solid #e5e7eb', borderRadius: 16, boxShadow: '0 2px 8px rgba(0,0,0,0.04)', padding: 40, maxWidth: 600, margin: '0 auto' }}>
          ...
          <form style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
            ...
            <label style={labelStyle}>Additional Details
              <textarea placeholder="Tell us more about your event, dietary requirements, budget, etc." rows={3} style={{ ...inputStyle, resize: 'vertical', minHeight: 60 }} />
            </label>
